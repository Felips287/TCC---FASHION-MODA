                        ...
                        <div class="collapse navbar-collapse" id="navbar">
                            <ul class="nav navbar-nav">
                                <li><a href="{$GET_SITE_ADM}"><i class="glyphicon glyphicon-home"></i> Home </a> </li>
                                 ...
                                 <li><a href="{$PAG_CATEGORIAS}"><i class="glyphicon glyphicon-list-alt"></i> Categorias </a> </li>
                                ...
                                <li><a href="{$PAG_ADM_PEDIDOS}" ><i class="glyphicon glyphicon-list"></i> Pedidos </a> </li>
            ...
            <div class="container"> 
                ...
                <div class="list-group">
                    <span class="list-group-item active"> Categorias</span>
                     ...
                     <br><a href="{$PAG_ADM_PRODUTOS}" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span> Todos</a> 

                    {foreach from=$CATEGORIAS item=C}
                    
                    <br><a href="{$C.cate_link_adm}" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span> {$C.cate_nome}</a> 
