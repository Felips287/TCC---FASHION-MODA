            ...
            <div class="container"> 
                ...
                <div class="list-group">
                    <span class="list-group-item active"> Categorias</span>
                     ...
                     <br><a href="{$PAG_PRODUTOS}" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span> Todos</a> 

                    {foreach from=$CATEGORIAS item=C}
                    
                    <br><a href="{$C.cate_link}" class="list-group-item"><span class="glyphicon glyphicon-menu-right"></span> {$C.cate_nome}</a> 
