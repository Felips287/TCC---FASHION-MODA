...
if(isset($_POST['cli_nome']) and isset($_POST['cli_email']) and
   isset($_POST['cli_cpf'])){
     ...
     <br>A senha para fazer login foi enviada para seu email cadastrado.
     <br><br>' . 'Acesse seu email e confira ! </div>';
